...
import { LoginInfoAdministratorDto } from "src/dtos/administrator/login.info.administrator";
...
export class authConotroller {
    constructor(public administratorService: AdministratorService) {}
        ...
        //   Sifrovanje (Tajna sifra -> JSON) -> binarna sifra -> Base64
        // HEX STRING
